...
if (!process.env.MESSENGER_SERVICE_URL) {
  throw new Error('MESSENGER_SERVICE_URL missing in environment file')
}
...
export const SERVICES: Record<string, string> = {
  ...
  [config.ROUTE_PATHS.MESSENGER]: process.env.MESSENGER_SERVICE_URL,
}
